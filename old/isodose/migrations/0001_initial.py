    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chromosome_bases', models.CharField(default='01', max_length=240, validators=[isodose.models.Simulation.validate_chromose])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('simulation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='isodose.Simulation')),
            ],
        ),
        migrations.AddField(
            model_name='ragarajainstructions',
            name='simulation',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='isodose.Simulation'),
        ),
        migrations.AddField(
            model_name='population',
            name='simulation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='isodose.Simulation'),
        ),
        migrations.AddField(
            model_name='location',
            name='population',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='isodose.Population'),
        ),
    ]
